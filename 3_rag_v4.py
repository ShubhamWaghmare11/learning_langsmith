...
PDF_PATH = r"C:\Users\Shubham\Downloads\IOT Notes (1).pdf"  # change to your file
...
def setup_pipeline(pdf_path: str, chunk_size=1000, chunk_overlap=150, embed_model_name="sentence-transformers/all-mpnet-base-v2", force_rebuild=False):
